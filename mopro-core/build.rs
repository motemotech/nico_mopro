...
fn main() -> Result<()> {
    ...
    let zkey_path = format!("examples/circom/verify-gov-sig/circuit_final.zkey");
    let wasm_path = format!("examples/circom/verify-gov-sig/verify-gov-sig.wasm");
    let arkzkey_path = format!("examples/circom/verify-gov-sig/circuit_final.arkzkey");
